document.addEventListener("DOMContentLoaded", function () {
    ...
    userDisplay.textContent = userEmail[0].toUpperCase() + userEmail[1].toUpperCase(); // Mostrar las dos primeras letras del correo
...
function loadProfileData() {
    ...
    document.getElementById('userEmail').innerText = localStorage.getItem('userEmail') || 'Usuario';
    document.getElementById('email').value = localStorage.getItem('userEmail') || '';
    darkModeSwitch.checked = localStorage.getItem('darkMode') === 'true';
    document.body.classList.toggle('dark-mode', darkModeSwitch.checked);
    profilePic.src = localStorage.getItem('profilePic') || 'https://via.placeholder.com/150';
    const dropPic = document.getElementById('pictureID');
    dropPic.src = localStorage.getItem('profilePic') || "https://via.placeholder.com/50";
}
